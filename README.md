...
- 下载页面：[https://github.com/cumtfc/yingge-album-tv/releases/tag/v1.0.4](https://github.com/cumtfc/yingge-album-tv/releases/tag/v1.0.4)
<!-- release-links:end -->

APK 发布包放在 `releases/` 目录中。下载后可通过 U 盘、ADB 或电视自带的安装器安装。

- `yingge-album-tv-v1.0.4-universal.apk`：通用包，适合不确定设备 ABI 或希望兼容更多电视盒子的用户。
- `yingge-album-tv-v1.0.4-armeabi-v7a.apk`：32 位 ARM 单 ABI 包，适合 armeabi-v7a 设备，体积更小。
