...
时光相册 TV 是一款面向 Android TV 的飞牛 NAS 相册浏览应用，用电视遥控器就能浏览 NAS 中的照片、视频、文件夹和相册。
...
<!-- release-links:start -->
- 产品介绍页：[https://cumtfc.github.io/time-album-tv/](https://cumtfc.github.io/time-album-tv/)
- 下载页面：[https://github.com/cumtfc/time-album-tv/releases/tag/v1.0](https://github.com/cumtfc/time-album-tv/releases/tag/v1.0)
<!-- release-links:end -->

APK 发布包放在 `releases/` 目录中。下载后可通过 U 盘、ADB 或电视自带的安装器安装。

- `time-album-tv-v1.0-universal.apk`：通用包，适合不确定设备 ABI 或希望兼容更多电视盒子的用户。
- `time-album-tv-v1.0-armeabi-v7a.apk`：32 位 ARM 单 ABI 包，适合 armeabi-v7a 设备，体积更小。
